...
class RestClient {
	...
	public function execute() {
		...
		curl_setopt($this->curl,CURLOPT_HTTPHEADER, $this->getSendHeaderData() );
	...
	private function treatResponse($r) {
		...
		for($i=0; $i<count($out[0]); $i++){
			$header[$out[1][$i]] = trim($out[3][$i]);
		}

		$this->headers['extra'] = (object)$header;
	...
	public function getResponseCode() {
		$code = (isset($this->headers['code']))?$this->headers['code']:NULL;
		return (int) $code;
	}
	...
	/**
	 * 
	 * Convenience method wrapping a commom heads call
	 * @param unknown_type $url
	 * @param array $params
	 * @param unknown_type $user
	 * @param unknown_type $pwd
	 * @param unknown_type $contentType
	 * @param unknown_type $headData
	 */
	public static function head($url, array $params=null, $user=null, $pwd=null, $contentType=null, $headData=null) {
		return self::call("HEAD", $url, $params, $user, $pwd, $contentType, $headData);
	}
